...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row vertical-margin form-group">
        ...
        <div class="col-md-4 col-md-offset-1">
            <asp:radiobuttonlist runat="server" ID="rdbAccountType">
                <asp:ListItem Text="From Checking to Saving Account" Value="checking" Selected="True"></asp:ListItem>
                <asp:ListItem Text="From Saving to Checking Account" Value="saving"></asp:ListItem>
            </asp:radiobuttonlist>
        </div>
    </div>
    <br />
    <div class="row vertical-margin form-group">
        <div class="col-md-4 col-md-offset-1">
            <asp:label ID="lblAmount" runat="server" text="Transfer Amount: "></asp:label>
        </div>
        <div class="col-md-2">
    ...
    <div class="row vertical-margin form-group">
        <div class="col-md-4 col-md-offset-1">
            <asp:button ID="btnTransfer" OnClick="btnTransfer_Click" runat="server" text="Transfer" CssClass="btn btn-primary"/>
        </div>
        <div class="col-md-6">
